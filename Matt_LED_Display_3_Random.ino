...
{ 
 unsigned long currentMillis = millis(); // Get the current time
  ...
  int value1 = random(100, 255);  // random number for value 1
  int value2 = random(100, 255);  // random number for value 2
  int value3 = random(100, 255);  // random number for value 3
  int value4 = random(100, 255);  // random number for value 4
  int value5 = random(100, 255);  // random number for value 5
 ...
 // 
 lcd.setCursor(11,0);           // move cursor to second line "1" and 13 spaces over
